            ...
            <div class="row mb-3">
                ...
                <div class="col-xl-10 col-lg-9 col-12 order-1 order-lg-2">
                    ...
                    <section id="main-slider-res"
                        ...
                        <ol class="carousel-indicators">
                            @foreach($sliders as $slider)
                                <li data-target="#main-slider-res" data-slide-to="{{$slider->id}}" @if($loop->first) class="active" @endif ></li>
                            @endforeach
                        </ol>
                        <div class="carousel-inner">
                            @foreach($sliders as $slider)
                        ...
                        <div class="category-section-slider dt-sl">
                            <div class="category-slider owl-carousel">
                                ...
                                <div class="item">
                                    <a href="#" class="promotion-category">
                                        <img
                                            src="./assets/img/category/restaurant-cutlery-circular-symbol-of-a-spoon-and-a-fork-in-a-circle.png"
                                            alt="">
